...
# ============================================================
# hal_probe.sh
# Vendor15 Runtime HAL Capability Probing
# ============================================================
#
...
#
# Developer utility for manual HAL probing via ADB.
# The integrated version of this script runs in the boot
# chain as /system/bin/hal_probe.sh (see repo root).
#
# Usage: vendor15-cli.sh probe
#
# Design:

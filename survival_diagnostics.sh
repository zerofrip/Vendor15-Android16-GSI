...
# Vendor15 Survival Mode — Telemetry & Diagnostics — Layer 7/7
# ============================================================
#
...
#
# Integrated into the boot chain via gsi_diagnostics.rc:
#   hal_probe_done=1    → start gsi_diagnostics
#   diagnostics_done=1  → set all_mitigations_done=1
#
# Properties set:
...
# ============================================================
CHAIN_PROPS="sys.gsi.boot_safety_done sys.gsi.gpu_stability_done sys.gsi.hal_mitigations_done sys.gsi.app_compat_done sys.gsi.forward_compat_done sys.gsi.hal_probe_done"
CHAIN_COMPLETED=0
CHAIN_TOTAL=0
...
# ============================================================
# 5. HAL probe results (from Layer 6)
# ============================================================
